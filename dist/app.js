...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ajax_ajax_loader__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__render_tile_context__ = __webpack_require__(1);
...
let Tilesets = class Tilesets {
  ...
  constructor() {
    this.tilesets = {};
    this.registerContext('default', new __WEBPACK_IMPORTED_MODULE_1__render_tile_context__["a" /* default */]({ tileset: __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* DEFAULT_TILESET */], cols: 7 }));
  }

  loadRemote(hash, remote) {
    this.registerContext(hash, new __WEBPACK_IMPORTED_MODULE_1__render_tile_context__["a" /* default */]({ remote }));
  }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BasicEntity; });
...
let BasicEntity = class BasicEntity {

  constructor(properties) {
    this.props = Object.assign({}, __WEBPACK_IMPORTED_MODULE_0__defaults__["a" /* BASIC */], properties);
  }

  render(ctx, x, y, neighbours) {
    __WEBPACK_IMPORTED_MODULE_1__tilesets__["a" /* default */].getContext(this.props.tileset).renderTile(ctx, x, y, this.props.tile);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__engine_render_tile_context__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__engine_tracker__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__engine_tilesets__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__engine_world_world__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tracker__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_entity_factory__ = __webpack_require__(10);


const MAX_HEIGHT = 2;
let World = class World extends __WEBPACK_IMPORTED_MODULE_0__tracker__["a" /* default */] {
  ...
  constructor(options) {
    ...
    for (let l = 0; l < MAX_HEIGHT; l++) {
      ...
      for (let i = 0; i < width; i++) {
        ...
        for (let j = 0; j < height; j++) {
          if (l === 0) {
            let Elem = __WEBPACK_IMPORTED_MODULE_1__game_entity_factory__["a" /* default */].getBlock('ground');
            let ground = new Elem();
            // if (Math.random() < 0.4) {   ground.props.tileset = 'hash' }
            row.push(ground);
          } else if (l === 1) {
            if (Math.random() < .3) {
              let Elem = __WEBPACK_IMPORTED_MODULE_1__game_entity_factory__["a" /* default */].getBlock('wall');
              let wall = new Elem();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EntityFactory; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__blocks_ground_entity__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__blocks_wall_entity__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__entities_basic_entity__ = __webpack_require__(3);


let GroundBlock = class GroundBlock extends __WEBPACK_IMPORTED_MODULE_0__entities_basic_entity__["a" /* default */] {
...
let WallBlock = class WallBlock extends __WEBPACK_IMPORTED_MODULE_0__entities_basic_entity__["a" /* default */] {
